...
export default function AddFilterModal({ isOpen, onClose, onAdd }) {
    ...
    return (
        <div className="add-filter-overlay" onClick={onClose}>
            <div className="add-filter-modal" onClick={(e) => e.stopPropagation()}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-wrapper">
                            <input
                                ...
                                maxLength={1024}
                            />
                            <span className="char-count">{query.length}/1024</span>
                        </div>
                    </div>

                    <div className="form-group preview-group">
                        <label>Preview</label>
                        {/* Empty preview space as per the image */}
                    </div>
                </div>
                ...
                <div className="add-filter-footer">
                    ...
                    <button
                        className={`add-submit-btn ${!name.trim() || !query.trim() ? 'disabled' : ''}`}
